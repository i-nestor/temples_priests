...
@section('admin-content')
    <div class="mx-auto max-width-980 my-5 p-4 rounded-4 shadow-sm bg-chocolate-200">
        <h1 class="text-3xl mb-4 text-green-600">Редактирование храма (монастыря)</h1>
                ...
                <form action="/admin/temples/{{ $temple->slug }}" method="POST"
                    ...
                    <div class="max-w-lg">
                        ...
                        <div class="image-group">
                            <input name="old-image" type="hidden" value="{{ $temple->image }}">

                            @if($temple->image)
                                <img id="preview-image" src="{{ asset('storage/' . $temple->image) }}"
                    ...
                    <div class="">
                        <div class="mb-2">
                            ...
                            <input id="name" name="name" type="text" autocomplete="name"
                                   ...
                                   value="{{ old('name', $temple->name) }}" autofocus>
                            @error('name')
                        ...
                        <div class="mb-2">
                            ...
                            <input id="shortname" name="shortname" type="text" autocomplete="shortname"
                                   ...
                                   value="{{ old('shortname', $temple->shortname) }}" autofocus>
                            @error('shortname')
                                <small class="my-2 block text-base text-red-600">{{ $message }} </small>
                            @enderror
                        </div>
                    ...
                    <div class="">
                        ...
                        <textarea id="description" type="hidden" name="description"
                               value="{{ old('description', $temple->description) }}">
                             {{ $temple->description }}
                        </textarea>
